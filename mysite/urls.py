...
from trips.views import hello_world, home, login, signup, mainweb, logout, base, manager, managerlogin, manageredit, modify, managerlogout, result, post, search
...
urlpatterns = [
    ...
    path('manager/edit', manageredit, name='Edit'),
